...
export function RecipeBrowser({ initialData, onAddToKart }: RecipeBrowserProps) {
  ...
  // keep in sync if initialData changes after fetch in parent
  useEffect(() => {
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-3 gap-4">
            {recipes.map((recipe, index) => {
              ...
              const recipeImage = recipe?.image || recipe?.strMealThumb || "https://placehold.co/600x400";
                  ...
                  <div className="p-4">
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <Button
                        ...
                        aria-label={`Add ${recipeName} to cart`}
                      >
